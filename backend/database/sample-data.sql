...
('SR-2025-001', 'RES001', 'Water Leak', 'Water', 'High', 'Leaking pipe near the meter box, water wastage occurring', '123 Main Street, Okahandja', 'In Progress'),
('SR-2025-002', '23456789', 'Meter Reading Issue', 'Electricity', 'Medium', 'Electricity meter reading seems incorrect, showing higher than normal usage', '45 Oak Avenue, Okahandja', 'Resolved'),
('SR-2025-003', '56789012', 'Billing Query', 'Billing', 'Low', 'Need clarification on December bill amount, appears higher than usual', '34 Market Square, Okahandja', 'Open'),
('SR-2025-004', '67890123', 'Street Light Issue', 'Infrastructure', 'Medium', 'Street light outside property not working for 3 days', '56 Independence Avenue, Okahandja', 'In Progress'),
('SR-2025-005', '89012345', 'Refuse Collection Issue', 'Refuse', 'High', 'Refuse not collected on scheduled days for 2 weeks', '23 Voortrekker Street, Okahandja', 'Open'),
('SR-2025-006', '90123456', 'Water Pressure', 'Water', 'Medium', 'Low water pressure during peak hours', '67 Kaiser Wilhelm Street, Okahandja', 'Resolved'),
('SR-2025-007', '22334455', 'Drainage Problem', 'Infrastructure', 'High', 'Blocked drainage causing flooding in yard', '12 Robert Mugabe Avenue, Okahandja', 'In Progress'),
('SR-2025-008', '44556677', 'Meter Replacement', 'Water', 'Low', 'Request for digital water meter upgrade', '34 Uhland Street, Okahandja', 'Open');

-- ===================================
-- NOTIFICATIONS
-- ===================================
-- Notifications will be generated dynamically by the application

-- ===================================
-- ACTIVITY LOG
-- ===================================
-- Activity will be logged automatically by the system
